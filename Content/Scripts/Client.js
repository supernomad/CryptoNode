...
App.Client = App.User.extend({
    validations: {
        ...
        roomname: {
            length: { minimum: 5, maximum: 256, messages: { minimum: 'Room should be more than 1 character.', maximum: 'Room should be less than 256 characters.' } }
        },
        roompassword: {
...
Socket.on('updateUser', function (data) {
    if (data && data.name && data.id) {
        var user = App.CurrentClient.get('currentRoom').get('users').findProperty('id', data.id);
